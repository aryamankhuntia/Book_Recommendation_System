...
from recommender.utils.util import read_yaml_file
...
from recommender.constant import *
...
class Configuration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            books_csv_dir = os.path.join(artifacts_dir, dataset_dir, data_ingestion_config['ingested_data_dir'], books_csv_file)
            ratings_csv_dir = os.path.join(artifacts_dir, dataset_dir, data_ingestion_config['ingested_data_dir'], ratings_csv_file)
            clean_data_dir = os.path.join(artifacts_dir, data_validation_config['clean_data_dir'])
            serialized_objects_dir = os.path.join(artifacts_dir, data_validation_config['serialized_objects_dir'])

            response = DataValidationConfig(
                clean_data_dir=clean_data_dir,
                books_csv_file=books_csv_dir,
                ratings_csv_file=ratings_csv_dir,
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            clean_data_file_path = os.path.join(artifacts_dir, data_validation_config['clean_data_dir'],'clean_data.csv')
            transformed_data_dir = os.path.join(artifacts_dir, data_transformation_config['transformed_data_dir'])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            transformed_data_file_dir = os.path.join(artifacts_dir, data_transformation_config['transformed_data_dir'], 'transformed_data.pkl')
